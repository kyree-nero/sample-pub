...
INSERT INTO AUTH_EXPR (RESOURCE, POLICY_EXPR) VALUES ('/sample/\d*', 'hasRole(''ROLE_USERS'')');
INSERT INTO AUTH_EXPR (RESOURCE, POLICY_EXPR) VALUES ('/read', 'hasRole(''ROLE_USERS'')');
INSERT INTO AUTH_EXPR (RESOURCE, POLICY_EXPR) VALUES ('/resources/.*', 'hasRole(''ROLE_USERS'')');
INSERT INTO AUTH_EXPR (RESOURCE, POLICY_EXPR) VALUES ('/login', 'hasRole(''ROLE_USERS'')');
COMMIT; 